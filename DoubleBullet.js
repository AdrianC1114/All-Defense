function DoubleBullet(x,y,directionx,directiony,angle,damage){
  Bullet.call(this,x,y,directionx,directiony,angle,damage);
  this.loadTexture("bullet2");
}
DoubleBullet.prototype = Object.create(Bullet.prototype);
DoubleBullet.prototype.update = function(){
